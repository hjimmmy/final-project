...
class Player extends Component {
  // Sets up property types to be used in defaultProps
  static propTypes = {
  ...
  // Defines initial property values
  static defaultProps = {
    autoplay: false,
...
//     return (
//       <div>
//         <img className="albumArtwork" src={this.state.artwork} alt="image" />
